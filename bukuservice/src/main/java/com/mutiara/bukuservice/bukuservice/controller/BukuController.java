package com.mutiara.bukuservice.bukuservice.controller;

import com.mutiara.bukuservice.bukuservice.model.Buku;
import com.mutiara.bukuservice.bukuservice.service.BukuService;
...
public class BukuController {
    ...
    public Buku save(@RequestBody Buku buku) {
        ...
        log.info("Menerima request POST buku baru. Judul Buku: {}, Pengarang: {}", buku.getJudul(),
                buku.getPengarang());
